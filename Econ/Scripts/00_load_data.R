...
epi.model.output <- read.csv(here::here("Econ/Data/Final", "2022-06-21_Naomi_grouped_totals.csv"))
...
load(here::here("Econ/Data/Final", "2022-06-20_Naomi_Vaccine_model_output_default.Rdata"))
