...
epi.model.output <- read.csv(here::here("Econ/Data/SA-fixed-reduction", "2022-06-14_Naomi_grouped_totals.csv"))
...
load(here::here("Econ/Data/SA-fixed-reduction", "2022-06-14_Naomi_Vaccine_model_output_FIXED_REDUCTION.Rdata"))
